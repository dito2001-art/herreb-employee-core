...
const definitions: CapabilityDefinition[] = [
  ...
  {
    id: "crm.write",
    description: "Write permitted CRM business data",
    risk: "YELLOW",
    allowedEmployees: ["EMP-001", "EMP-002"],
  },
  {
    id: "offering.read",
  ...
  },
  {
    ...
    description: "Recommend authoritative offerings",
    risk: "GREEN",
  ...
  },
  {
    ...
    description: "Continuously qualify and work tenant-provided lead and customer databases",
    risk: "GREEN",
    allowedEmployees: ["EMP-001"],
  },
  {
  ...
  {
    id: "sale.progress",
    description: "Progress an accepted commercial transaction",
    risk: "YELLOW",
    allowedEmployees: ["EMP-001"],
  },
  {
    id: "whatsapp.send",
    description: "Send an authorized WhatsApp message",
    risk: "YELLOW",
    allowedEmployees: ["EMP-001"],
  },
  {
    id: "followup.schedule",
    description: "Schedule a sales follow-up",
    risk: "YELLOW",
    allowedEmployees: ["EMP-001"],
  },
  {
    id: "calendar.read",
    description: "Read calendar availability and events",
    risk: "GREEN",
    allowedEmployees: ["EMP-002"],
  },
  {
    id: "calendar.write",
  ...
  {
    id: "email.read",
    description: "Read authorized email context",
    risk: "GREEN",
    allowedEmployees: ["EMP-002"],
  },
  {
    id: "email.send",
    description: "Send authorized email",
    risk: "YELLOW",
    allowedEmployees: ["EMP-002"],
  },
  {
    id: "task.schedule",
    description: "Schedule assistant work",
    risk: "YELLOW",
    allowedEmployees: ["EMP-002"],
  },
  {
    id: "marketing.read",
    description: "Read marketing data",
    risk: "GREEN",
    allowedEmployees: ["EMP-003"],
  },
  {
    id: "marketing.write",
    description: "Change permitted marketing data",
    risk: "YELLOW",
    allowedEmployees: ["EMP-003"],
  },
  {
    id: "research.web",
    description: "Perform public web research",
    risk: "GREEN",
    allowedEmployees: ["EMP-003"],
  },
  {
    id: "content.create",
    description: "Create marketing content drafts",
    risk: "GREEN",
    allowedEmployees: ["EMP-003"],
  },
  {
