...
const definitions: CapabilityDefinition[] = [
  ...
  { id: "offering.read", description: "Read authoritative offerings", risk: "GREEN", allowedEmployees: ["EMP-001", "EMP-003"] },
  { id: "offering.recommend", description: "Recommend authoritative offerings", risk: "GREEN", allowedEmployees: ["EMP-001"] },
  { id: "lead.discover", description: "Discover prospective leads within the tenant sales policy and ICP", risk: "GREEN", allowedEmployees: ["EMP-001"] },
  { id: "lead.database.sell", description: "Continuously qualify and work tenant-provided lead and customer databases", risk: "GREEN", allowedEmployees: ["EMP-001"] },
  { id: "lead.qualify", description: "Qualify and prioritize tenant sales leads", risk: "GREEN", allowedEmployees: ["EMP-001"] },
  { id: "sales.outreach", description: "Initiate policy-authorized proactive commercial outreach", risk: "GREEN", allowedEmployees: ["EMP-001"] },
  ...
  { id: "followup.schedule", description: "Schedule a sales follow-up", risk: "YELLOW", allowedEmployees: ["EMP-001"] },
  ...
  { id: "task.schedule", description: "Schedule assistant work", risk: "YELLOW", allowedEmployees: ["EMP-002"] },
